...
## 6. Pull request
Push the branch. Open a PR with the template: `Closes #<n>` in the ticket section, the Jira key in the title if there is one, the verification block filled, assumptions and open points listed.
